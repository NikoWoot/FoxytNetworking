...
{
    public class SimpleDataProcessor : DefaultDataProcessor<ArraySegment<byte>>
    {
        public SimpleDataProcessor(Session session)
            : base(session)
        {
        }
